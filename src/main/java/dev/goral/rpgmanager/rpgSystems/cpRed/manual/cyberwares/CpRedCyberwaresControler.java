...
//    public Map<String, Object> getAllCyberwares() { // List<CpRedCyberwaresDTO>
...
//    public Map<String, Object> getCyberwareById(@PathVariable("cyberwareId") Long cyberwareId) { // CpRedCyberwaresDTO
...
//    public Map<String, Object> getAllCyberwaresForAdmin() { // List<CpRedCyberwares>
