...
class Human extends Race
{
    ...
    {
        $this->defaultPerks[PerkName::WalkaWrecz] = 20;
        $this->defaultPerks[PerkName::UmiejetnosciStrzeleckie] = 20;
        $this->defaultPerks[PerkName::Krzepa] = 20;
        $this->defaultPerks[PerkName::Odpornosc] = 20;
        $this->defaultPerks[PerkName::Zrecznosc] = 20;
        ...
        $this->defaultPerks[PerkName::Zywotnosc] = 11;
        ...
        $this->defaultPerks[PerkName::PunktyPrzeznaczenia] = 3;
        $this->defaultPerks[PerkName::PunktySzczescia] = 3;
    }
}